...
.method writeLayout()V
    ...
    const-string v3, "app:layout_constraintVertical_weight"

    const/high16 v4, -0x40800000    # -1.0f

    invoke-virtual {p0, v3, v2, v4}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V

    .line 21
    iget v2, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->horizontalWeight:F

    const-string v4, "app:layout_constraintHorizontal_weight"

    const/high16 v5, -0x40800000    # -1.0f

    invoke-virtual {p0, v4, v2, v5}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    const-string v5, "app:layout_constraintHorizontal_chainStyle"

    const/4 v6, 0x0

    invoke-virtual {p0, v5, v2, v6}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    const-string v6, "app:layout_constraintVertical_chainStyle"

    const/4 v7, 0x0

    invoke-virtual {p0, v6, v2, v7}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    const-string v7, "app:barrierDirection"

    const/high16 v8, -0x40800000    # -1.0f

    invoke-virtual {p0, v7, v2, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    invoke-virtual {p0, v9, v2, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    invoke-direct {p0, v9, v2, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeDimension(Ljava/lang/String;II)V
    ...
    invoke-direct {p0, v9, v2, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeBoolen(Ljava/lang/String;ZZ)V
    ...
    invoke-virtual {p0, v8, v2}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeXmlConstraint(Ljava/lang/String;I)V
    ...
    .line 60
    iget v8, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightDefault:I

    const/4 v9, 0x0

    const-string v10, "app:layout_constraintHeight_default"

    invoke-direct {p0, v10, v8, v2, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeEnum(Ljava/lang/String;I[Ljava/lang/String;I)V

    .line 61
    iget v8, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightPercent:F

    const/high16 v9, 0x3f800000    # 1.0f

    const-string v10, "app:layout_constraintHeight_percent"

    invoke-virtual {p0, v10, v8, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V

    .line 62
    iget v8, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightMin:I

    const/4 v9, 0x0

    const-string v10, "app:layout_constraintHeight_min"

    invoke-direct {p0, v10, v8, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeDimension(Ljava/lang/String;II)V

    .line 63
    iget v8, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->heightMax:I
    ...
    .line 64
    iget-boolean v8, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->constrainedHeight:Z

    const-string v10, "android:layout_constrainedHeight"

    invoke-direct {p0, v10, v8, v9}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeBoolen(Ljava/lang/String;ZZ)V

    .line 65
    iget v8, v1, Landroidx/constraintlayout/widget/ConstraintSet$Layout;->widthDefault:I
    ...
    invoke-virtual {p0, v3, v2, v8}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;FF)V
    ...
    invoke-virtual {p0, v5, v2}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeVariable(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v7, v3, v2, v4}, Landroidx/constraintlayout/widget/ConstraintSet$WriteXmlEngine;->writeEnum(Ljava/lang/String;I[Ljava/lang/String;I)V
