...
.method public constructor <init>([BLjava/io/PrintStream;Ljava/lang/String;Lcom/android/dx/command/dump/Args;)V
    ...
    .line 5
    iget p1, p4, Lcom/android/dx/command/dump/Args;->width:I
    ...
    :cond_0
    iput p1, p0, Lcom/android/dx/command/dump/BaseDumper;->width:I

    .line 6
    iput-object p3, p0, Lcom/android/dx/command/dump/BaseDumper;->filePath:Ljava/lang/String;

    .line 7
    iget-boolean p1, p4, Lcom/android/dx/command/dump/Args;->strictParse:Z

    iput-boolean p1, p0, Lcom/android/dx/command/dump/BaseDumper;->strictParse:Z

    const/4 p1, 0x0

    .line 8
    iput p1, p0, Lcom/android/dx/command/dump/BaseDumper;->indent:I

    .line 9
    iget-boolean p2, p0, Lcom/android/dx/command/dump/BaseDumper;->rawBytes:Z
    ...
    :goto_0
    iput-object p2, p0, Lcom/android/dx/command/dump/BaseDumper;->separator:Ljava/lang/String;
    ...
    .line 13
    iget p1, p0, Lcom/android/dx/command/dump/BaseDumper;->width:I
...
.method protected final twoColumns(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v2, p2}, Ljava/io/FilterWriter;->write(Ljava/lang/String;)V
    ...
    .line 9
    :cond_1
    invoke-virtual {v2}, Ljava/io/FilterWriter;->flush()V
