...
# instance fields
.field final synthetic a:Ld/z;

.field final synthetic c:Ld/b;


# direct methods
.method constructor <init>(Ld/b;Ld/z;)V
    .locals 0
    ...
    .line 1
    iput-object p1, p0, Ld/c;->c:Ld/b;

    iput-object p2, p0, Ld/c;->a:Ld/z;
...
.method public b(Ld/w;J)V
    ...
    .line 6
    invoke-virtual {v2}, Ld/b;->t()V

    .line 7
    :try_start_0
    iget-object v3, p0, Ld/c;->a:Ld/z;

    invoke-interface {v3, p1, v0, v1}, Ld/z;->b(Ld/w;J)V
    ...
    .line 9
    invoke-virtual {v2, p1}, Ld/b;->p(Ljava/io/IOException;)Ljava/io/IOException;
...
.method public bridge synthetic timeout()Ld/aw;
    ...
    .line 1
    invoke-virtual {p0}, Ld/c;->timeout()Ld/b;
