...
.method public static synthetic b(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J
    ...
    .line 16
    :cond_0
    invoke-static {p0, p1, p2}, Lh/q/s;->a(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
...
.method static synthetic e(Ljava/io/InputStream;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/io/BufferedReader;
    .locals 0
...
.method static synthetic f(Ljava/io/OutputStream;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/io/BufferedWriter;
    .locals 0
...
.method static synthetic g(Ljava/lang/String;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/io/ByteArrayInputStream;
    .locals 0
...
.method public static final h(Ljava/io/BufferedInputStream;)Lh/m/dn;
    .locals 1
    ...
    .line 1
    new-instance v0, Lh/q/t;

    invoke-direct {v0, p0}, Lh/q/t;-><init>(Ljava/io/BufferedInputStream;)V
...
.method public static final i(Ljava/io/InputStream;)[B
    ...
    .line 22
    invoke-static {p0, v0, v1, v2, v3}, Lh/q/s;->b(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J
...
.method static synthetic j(Ljava/io/InputStream;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/io/InputStreamReader;
    .locals 0
...
.method static synthetic k(Ljava/io/OutputStream;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/io/OutputStreamWriter;
    .locals 0
...
.method public static final l(Ljava/io/InputStream;I)[B
    .locals 3
    .param p0    # Ljava/io/InputStream;
        .annotation build Le/b/a/f;
        .end annotation
    ...
    .line 7
    invoke-static {p0, v0, p1, v1, v2}, Lh/q/s;->b(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J
...
.method public static synthetic m(Ljava/io/InputStream;IILjava/lang/Object;)[B
    .locals 0
    ...
    .line 5
    :cond_0
    invoke-static {p0, p1}, Lh/q/s;->l(Ljava/io/InputStream;I)[B
...
.method private static final n(Ljava/io/InputStream;I)Ljava/io/BufferedInputStream;
    .locals 1
...
.method private static final o(Ljava/io/OutputStream;I)Ljava/io/BufferedOutputStream;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final p(Ljava/io/InputStream;Ljava/nio/charset/Charset;)Ljava/io/BufferedReader;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final q(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)Ljava/io/BufferedWriter;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final r(Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/io/ByteArrayInputStream;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final s([B)Ljava/io/ByteArrayInputStream;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final t([BII)Ljava/io/ByteArrayInputStream;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final u(Ljava/io/InputStream;Ljava/nio/charset/Charset;)Ljava/io/InputStreamReader;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
...
.method private static final v(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)Ljava/io/OutputStreamWriter;
    .locals 1
    .annotation build Lh/i/i;
    .end annotation
