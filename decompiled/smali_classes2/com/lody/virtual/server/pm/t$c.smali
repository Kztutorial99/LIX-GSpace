.class final Lcom/lody/virtual/server/pm/t$c;
...
.method private constructor <init>(Lcom/lody/virtual/server/pm/t;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/lody/virtual/server/pm/t$c;->a:Lcom/lody/virtual/server/pm/t;
    ...
    iput-object p1, p0, Lcom/lody/virtual/server/pm/t$c;->af:Ljava/util/HashMap;
...
.method synthetic constructor <init>(Lcom/lody/virtual/server/pm/t;Lcom/lody/virtual/server/pm/t$b;)V
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/lody/virtual/server/pm/t$c;-><init>(Lcom/lody/virtual/server/pm/t;)V

    return-void
.end method

.method static synthetic c(Lcom/lody/virtual/server/pm/t$c;)Ljava/util/HashMap;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/lody/virtual/server/pm/t$c;->af:Ljava/util/HashMap;
...
.method protected bridge synthetic b(Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;II)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/lody/virtual/server/pm/t$c;->d(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;II)Landroid/content/pm/ResolveInfo;
...
.method protected d(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;II)Landroid/content/pm/ResolveInfo;
    .locals 4

    .line 31
    iget-object v0, p1, Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;->a:Lcom/lody/virtual/server/pm/parser/VPackage$a;

    .line 32
    iget-object v1, p0, Lcom/lody/virtual/server/pm/t$c;->a:Lcom/lody/virtual/server/pm/t;

    iget-object v2, v0, Lcom/lody/virtual/server/pm/parser/VPackage$a;->a:Landroid/content/pm/ServiceInfo;

    iget v3, p0, Lcom/lody/virtual/server/pm/t$c;->ae:I
    ...
    invoke-static {v0, v3, v1, p3}, Lcom/lody/virtual/server/pm/parser/a;->j(Lcom/lody/virtual/server/pm/parser/VPackage$a;ILcom/lody/virtual/server/pm/PackageUserState;I)Landroid/content/pm/ServiceInfo;
    ...
    .line 37
    iget p3, p0, Lcom/lody/virtual/server/pm/t$c;->ae:I
...
.method protected e(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)Ljava/lang/Object;
    .locals 0

    .line 47
    iget-object p1, p1, Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;->a:Lcom/lody/virtual/server/pm/parser/VPackage$a;
...
.method public f(Landroid/content/Intent;Ljava/lang/String;ZI)Ljava/util/List;
    ...
    .line 7
    :goto_0
    iput v0, p0, Lcom/lody/virtual/server/pm/t$c;->ae:I
...
.method public g(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 9
    iput p3, p0, Lcom/lody/virtual/server/pm/t$c;->ae:I
...
.method protected bridge synthetic h(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/lody/virtual/server/pm/t$c;->o(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)V

    return-void
.end method

.method public i(Landroid/content/Intent;Ljava/lang/String;ILjava/util/ArrayList;I)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected bridge synthetic l(Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;Ljava/util/List;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/lody/virtual/server/pm/t$c;->q(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;Ljava/util/List;)Z
...
.method public final m(Lcom/lody/virtual/server/pm/parser/VPackage$a;)V
    .locals 3

    .line 20
    iget-object v0, p0, Lcom/lody/virtual/server/pm/t$c;->af:Ljava/util/HashMap;
...
.method protected bridge synthetic n(Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/lody/virtual/server/pm/t$c;->t(Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)Z
...
.method protected o(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)V
    .locals 0
...
.method protected bridge synthetic p(I)[Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;
    ...
    .line 5
    invoke-virtual {p0, p1}, Lcom/lody/virtual/server/pm/t$c;->u(I)[Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;
...
.method protected q(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;Ljava/util/List;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Lcom/lody/virtual/server/pm/parser/VPackage$a;->a:Landroid/content/pm/ServiceInfo;
...
.method protected bridge synthetic r(Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/lody/virtual/server/pm/t$c;->w(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)Z
...
.method protected bridge synthetic s(Lcom/lody/virtual/server/pm/parser/VPackage$IntentInfo;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/lody/virtual/server/pm/t$c;->e(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)Ljava/lang/Object;
...
.method protected t(Ljava/lang/String;Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)Z
    .locals 0

    .line 30
    iget-object p2, p2, Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;->a:Lcom/lody/virtual/server/pm/parser/VPackage$a;
...
.method protected u(I)[Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;
    .locals 0
...
.method public final v(Lcom/lody/virtual/server/pm/parser/VPackage$a;)V
    .locals 3
...
.method protected w(Lcom/lody/virtual/server/pm/parser/VPackage$ServiceIntentInfo;)Z
    .locals 0
